...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <?php
                    $query = mysqli_query($conn, "SELECT * FROM data_kendaraan WHERE id='$_GET[kd]'");
                    $data  = mysqli_fetch_array($query);
                    ?>
                                <!-- </div> -->
                                <div class="panel-body">
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-kendaraan.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
                                  ...
                                  <a href="kendaraan.php" class="btn btn-sm btn-danger"> Batal</a>
                              </div>
                          </div>
