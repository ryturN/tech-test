                            <ul class="sidebar-menu">
                                ...
                                <a href="#">
                                    ...
                                    <span>Data Kendaran</span>
                                    <i class="fa fa-angle-left pull-right"></i>
                                </a>
                                    <ul class="treeview-menu">
                                        <li><a href="kendaraan.php"><i class="fa fa-angle-double-right"></i> Data Kendaraan</a></li>
                                        <li><a href="input-kendaraan.php"><i class="fa fa-angle-double-right"></i> Tambah Kendaraan</a></li>
                                    </ul>
                                </li>        
                                <li class="treeview">
                                <a href="#">
                                ...
                                <a href="#">
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="laporan-anggota.php"><i class="fa fa-angle-double-right"></i> Laporan Pemesanan </a></li>
                                    </ul>
                                </li>
