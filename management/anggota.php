...
<?php } ?>
                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                ...
                                <div class="panel-body table-responsive">
                                    ...
                                    <?php
                    $query1="select * from data_driver";
              ...
              ?>
                  ...
                  <?php $tampil=mysqli_query($conn ,"select * from data_driver order by id");
                        $user=mysqli_num_rows($tampil);
                    ?>
                  <center><h4>Jumlah Driver : <?php echo "$user"; ?> Orang </h4> </center>
                  
                <div class="text-right" style="margin-top: 10px;">
                 <a href="anggota.php" class="btn btn-sm btn-info">Refresh Driver <i class="fa fa-refresh"></i></a> <a href="input-anggota.php" class="btn btn-sm btn-warning">Tambah Anggota <i class="fa fa-arrow-circle-right"></i></a>
                </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        </div>
