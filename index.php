...
<head>
    ...
    <meta name="description" content="CarOrder">
    <meta name="keywords" content="Car,Order">
...
tanggallengkap = namahari[hari] + ", " +tanggal + " " + namabulan[bulan] + " " + tahun;
    ...
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
      ...
      <body class="skin-black">
		...
		<b>Selamat Datang di CarOrder Pro Version, Untuk Login Admin silahkan klik Icon User atau klik <a href="login.html">disini</a></b>
          </div>
            </div>
                        ...
                        <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-pengunjung.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  ...
                                  <option> -- Pilih Salah Satu --</option>
                                  <option value="1 Teknik Elektronika A"> 1 Teknik Elektronika A</option>
                                  <option value="1 Teknik Elektronika B"> 1 Teknik Elektronika B</option>
                                  <option value="1 Teknik Mesin A"> 1 Teknik Mesin A</option>
                                  <option value="1 Teknik Mesin B"> 1 Teknik Mesin B</option>
                                  <option value="1 Teknik Industri"> 1 Teknik Industri</option>
                                  <option value="2 Teknik Elektronika A"> 2 Teknik Elektronika A</option>
                                  <option value="2 Teknik Elektronika B"> 2 Teknik Elektronika B</option>
                                  <option value="2 Teknik Mesin A"> 2 Teknik Mesin A</option>
                                  <option value="2 Teknik Mesin B"> 2 Teknik Mesin B</option>
                                  <option value="2 Teknik Industri"> 2 Teknik Industri</option>
                                  <option value="3 Teknik Elektronika A"> 3 Teknik Elektronika A</option>
                                  <option value="3 Teknik Elektronika B"> 3 Teknik Elektronika B</option>
                                  <option value="3 Teknik Mesin A"> 3 Teknik Mesin A</option>
                                  <option value="3 Teknik Industri"> 3 Teknik Industri</option>
                                  </select>
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Pencarian</label>
                              <div class="col-sm-10">
...
<!-- Data Total Pengunjung -->                        
              ...
              <!-- row end -->
                ...
                <div class="footer-main">
                    Copyright &copy <a href="https://poltek-gt.ac.id/v2/" target="_blank">Politek Gajah Tunggal</a> 2020
                </div>
            </aside><!-- /.right-side -->
...
<div class="modal fade" id="contact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      PerPusWeb adalah aplikasi perpustakaan berbasis website yang responsif, PerPusWeb Versi ini adalah versi PerPusWeb Pro untuk info, saran, maupun kritik bisa menghubungi
      Politeknik Gajah Tunggal :
      <table>
      <tr>
      <td>Telp</td> <td>:</td> <td>021 - 5900468</td>
      </tr>
      <tr>
      <td>FAX</td> <td>:</td> <td>021 - 5900481</td>
      </tr>
      <br />
      <tr>
      <td>Email</td><td>:</td> <td><a href="mailto:administrasi@poltek-gt.ac.id">administrasi@poltek-gt.ac.id</a> | <a href="mailto:gt.poltek@gt-tires.com">gt.poltek@gt-tires.com</a></td>
      </tr> 
      <br />
      <br />
      <tr>
      <td>Website</td>    <td>:</td> <td><a href="https://poltek-gt.ac.id/v2/" target="_blank">Politeknik Gajah Tunggal</a></td>
      </tr>
       </table>
      </div>
