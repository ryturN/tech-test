...
<?php } ?>
                ...
                <section class="content">
                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                ...
                                <div class="panel-body table-responsive">
                                    ...
                                    <?php
                    $query1="select * from status_driver";
                    
                    if(isset($_POST['qcari'])){
	               $qcari=$_POST['qcari'];
	               $query1="SELECT * FROM  status_driver 
	               where no_anggota like '%$qcari%'
	               or nama like '%$qcari%'  ";
                    }
                  ...
                  <thead>
                      <tr>
                        ...
                        <th><center>Type Kendaran </center></th>
              ...
              ?>
                  ...
                  <?php $tampil=mysqli_query($conn ,"select * from status_driver order by id");
                        $user=mysqli_num_rows($tampil);
                    ?>
                  <center><h4>Jumlah Driver : <?php echo "$user"; ?> Orang </h4> </center>
                  
                <div class="text-right" style="margin-top: 10px;">
                 <a href="laporan-anggota.php" class="btn btn-sm btn-info">Refresh Driver <i class="fa fa-refresh"></i></a> 
                 <form action="export.php" method="post">
    <input type="submit" class="btn btn-sm btn-warning " value="Export to CSV">
</form>
                </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
