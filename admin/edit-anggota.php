...
<head>
    ...
    <meta name="description" content="Politeknik Gajah Tunggal">
...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <?php
                    $query = mysqli_query($conn,"SELECT * FROM data_driver WHERE id='$_GET[kd]'");
                    ...
                    ?>
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-anggota.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">No Anngota</label>
                              <div class="col-sm-8">
                                  <input name="no_anggota" type="text" id="no_anggota" class="form-control" placeholder="Ex : 00123" value="<?php echo $data['no_anggota']; ?>" required />
